...
import { InputTextWithLabel, Card, PhoneInput as CustomPhoneNumber, Snackbar, UnsavedData } from "../../components";
                ...
                <Grid container item xs={12} spacing={2}>
                  <Grid item xs={3}>
                    <InputTextWithLabel
                      ...
                      helperText={
                        siteNameInvalid ? "Site Name is Required" : ""
                      }
                    />
                  </Grid>
                  <Grid item xs={3}>
                  ...
                  <Grid item xs={3}>
                    <InputTextWithLabel
                      ...
                      helperText={
                        siteCodeInvalid ? "Site Code is Required" : ""
                      }
                    />
                  </Grid>
                  <Grid item xs={3}>

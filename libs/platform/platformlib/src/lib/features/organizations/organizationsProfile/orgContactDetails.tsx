...
import { organizationSelector, selectedId, selectOrganizations } from '@cloudcore/redux-store'
...
export const OrgContactDetails = () => {
    ...
    const organization = useSelector((state: any) => organizationSelector.selectById(state, testId))
    return (

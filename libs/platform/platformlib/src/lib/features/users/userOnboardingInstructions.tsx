import styles from './userOnboardingInstructions.module.css';

import { Box, Button, Card, Grid, MobileStepper, Paper, Typography} from '@mui/material';
...
const UserOnboardingInstructions =()=> {
    ...
    return (
        <Grid container >
            <TitleAndCloseIcon breadCrumbOrigin="ALL USERS" breadCrumbTitle="Import Users" onClickButton={closeInstructions} ></TitleAndCloseIcon>
        <Grid item xs={12}>
        <Grid container style={style.Grid} paddingX={3}>
            ...
            <LowerButton buttonName="NEXT" onClickButton={moveUserOnboarding}></LowerButton>              
        </Grid>
        </Grid>
        </Grid>

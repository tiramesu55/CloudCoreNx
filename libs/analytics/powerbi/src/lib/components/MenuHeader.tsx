    ...
    return (
     <>
              ...
              {reports?.map((item: any, ind: any) => {
                return <Box
                  sx={{ ml: 3, display: "flex", alignItems: "center", height: "64px" }}
                  onMouseEnter={(e: { currentTarget: SetStateAction<HTMLElement | null>; }) => {
                ...
                >
                  ...
                  </Typography>
                  {
                    ...
                    >
                      {
                        item.reports.map((sub: any, indx: any) => <MenuItem
